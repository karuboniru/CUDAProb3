...
template <typename T> HOSTDEVICEQUALIFIER constexpr T ct_sqr(T x) {
  return x * x;
}

template <typename T> HOSTDEVICEQUALIFIER constexpr T ct_cube(T x) {
  return x * x * x;
}
...
multiply_complex_matrix(ComplexNumber<FLOAT_T> A[][3],
                        ComplexNumber<FLOAT_T> B[][3],
                        ComplexNumber<FLOAT_T> C[][3]) {
 ...
 */
template <typename FLOAT_T>
HOSTDEVICEQUALIFIER void multiply_complex_matvec(ComplexNumber<FLOAT_T> A[][3],
                                                 ComplexNumber<FLOAT_T> V[3],
                                                 ComplexNumber<FLOAT_T> W[3]) {
 ...
 */
template <typename FLOAT_T>
HOSTDEVICEQUALIFIER void copy_complex_matrix(ComplexNumber<FLOAT_T> A[][3],
                                             ComplexNumber<FLOAT_T> B[][3]) {
 ...
 */
template <typename FLOAT_T>
HOSTDEVICEQUALIFIER void clear_complex_matrix(ComplexNumber<FLOAT_T> A[][3]) {
  A[0][0].re = 0;
  A[0][0].im = 0;
  A[0][1].re = 0;
  A[0][1].im = 0;
